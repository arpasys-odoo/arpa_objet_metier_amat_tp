...
class SaleOrder(models.Model):
    ...
    bon_intervention_id = fields.Many2one('bon_intervention.bon_intervention', 
                                          string='Bon d\'Intervention',
                                          help="Bon d\'Intervention à l\'origine de ce devis/commande",
                                          index=True, ondelete='set null')
    bon_intervention_ids = fields.One2many('bon_intervention.bon_intervention', 'sale_order_id', 
                                           string='Bons d\'intervention')
    bon_intervention_count = fields.Integer(compute='_compute_bon_intervention_count', 
                                            string='Nombre de bons d\'intervention')
    has_maintenance_contract = fields.Boolean(string='Contrat de maintenance', 
                                              help="Indique si ce devis concerne un contrat de maintenance")
